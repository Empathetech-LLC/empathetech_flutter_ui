    ...
    await storeColorScheme(
      colorScheme: isDark
          ? ColorScheme.fromSeed(
              ...
              seedColor: primary,
              primary: primary,
              primaryContainer: primary.withValues(alpha: containerOpacity),
              onPrimary: onPrimary,
              onPrimaryContainer: onPrimary,
              secondary: secondary,
              secondaryContainer: secondary.withValues(alpha: containerOpacity),
              onSecondary: onSecondary,
              onSecondaryContainer: onSecondary,
              tertiary: tertiary,
              tertiaryContainer: tertiary.withValues(alpha: containerOpacity),
