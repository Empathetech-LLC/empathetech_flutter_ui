...
class EzSettingsHome extends StatefulWidget {
  ...
  const EzSettingsHome({
    ...
    this.localeSpacer = EzConfig.layout.divider,
    ...
    this.quickConfigSpacer = EzConfig.layout.divider,
    this.randomSpacer = EzConfig.layout.spacer,
    this.extraKeys,
    required this.appName,
    this.androidPackage,
    this.resetSpacer = EzConfig.layout.spacer,
    this.skipKeys,
    this.footer,
  });
