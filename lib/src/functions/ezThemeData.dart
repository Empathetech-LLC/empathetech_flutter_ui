...
/// Creates a [ThemeData] with a [ColorScheme] generated by [EzConfig] via [ezColorScheme]
/// Also has some tweaks to the base Material [ThemeData], mostly to the [TextStyle]s
